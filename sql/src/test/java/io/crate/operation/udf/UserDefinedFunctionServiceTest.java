...
public class UserDefinedFunctionServiceTest extends CrateUnitTest {
    ...
    public void testRemoveFunction() throws Exception {
        ...
        UserDefinedFunctionsMetaData newMetaData = removeFunction(metaData, same1.createMethodSignature(), false);
    ...
    public void testRemoveIfExistsEmptyMetaData() throws Exception {
        UserDefinedFunctionsMetaData newMetaData = removeFunction(null, same1.createMethodSignature(), true);
    ...
    public void testRemoveDoesNotExist() throws Exception {
        ...
        UserDefinedFunctionsMetaData metaData = UserDefinedFunctionsMetaData.of(same1);
        removeFunction(metaData, different.createMethodSignature(), false);
    }
